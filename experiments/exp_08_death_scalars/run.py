"""
Exp 08 coverage check — 8 priors including new hiv.rel_death /
hiv.rel_death_on_art scalars from stisim feat/hiv-death-rate-pars.
rel_migration=0.5 fixed, ART driven by p_art.csv, aggressive condom
schedule locked. 3x3 diagnostic figure.
"""
